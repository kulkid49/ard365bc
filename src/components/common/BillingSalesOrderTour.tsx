...
const STORAGE_KEY = 'qa.billingSalesOrderTour.completed'
...
export function BillingSalesOrderTour() {
  const [searchParams, setSearchParams] = useSearchParams()
  const forceStart = searchParams.get('tour') === 'billing'
    ...
    () => [
      {
        ...
        subSteps: [
          {
            id: 'header',
            selector: '[data-tour="bill-header"]',
            title: 'Billing & Sales Order Review',
            body:
              'Welcome to Billing & Sales Order Review — Step 4 of the Agentic AR process. The Billing Agent has interpreted the contract and prepared a Sales Order ready for review and one-click creation in Dynamics 365 Business Central.',
          },
        ],
      },
      {
        ...
        subSteps: [
          {
            id: 'contract',
            selector: '[data-tour="bill-contract-context"]',
            title: 'Left Panel – Contract Context',
            body:
              'This panel shows the contract context extracted by the Contract Intelligence Agent, including billing model (TNM/Fixed/Milestone), key terms, and risk signals. It explains why the Billing Agent built certain line items and controls.',
          },
        ],
      },
      {
        ...
        subSteps: [
          {
            id: 'editor',
            selector: '[data-tour="bill-so-editor"]',
            title: 'Right Panel – Sales Order Editor',
            body:
              'This is the Sales Order editor mirroring D365 structure. The Billing Agent pre-fills line items, rates/milestones, and tax information; you can make final adjustments before pushing the payload to D365 BC.',
          },
        ],
      },
      {
        ...
        subSteps: [
          {
            id: 'header-section',
            selector: '[data-tour="bill-so-header"]',
            title: 'Sales Order Header Section',
            body:
              'Header fields are populated from Customer Master validation and contract terms: customer context, posting date, currency, and payment terms. They are designed to map cleanly into D365 BC master data.',
          },
        ],
      },
      {
        ...
        subSteps: [
          {
            id: 'lines',
            selector: '[data-tour="bill-lines"]',
            title: 'Line Items Grid',
            body:
              'This grid contains the billing logic in action. TNM uses rate cards and hours; Fixed/Milestone contracts show deliverables and triggers. Item/tax groups are validated against D365 BC masters to prevent posting errors.',
          },
        ],
      },
      {
        ...
        subSteps: [
          {
            id: 'totals',
            selector: '[data-tour="bill-totals"]',
            title: 'Totals Panel',
            body:
              'Totals update in real time as you edit. The system compares the Sales Order total against the contract value and flags variance so you can catch issues early before anything is posted to D365 BC.',
          },
        ],
      },
      {
        ...
        subSteps: [
          {
            id: 'risk',
            selector: '[data-tour="bill-risk-panel"]',
            title: 'Risk & Non-Standard Terms',
            body:
              'Any non-standard clauses detected by Contract Intelligence are surfaced here for review. This keeps standard cases fully automated while ensuring exceptions get a human checkpoint before approval.',
          },
        ],
      },
      {
        ...
        subSteps: [
          {
            id: 'd365-actions',
            selector: '[data-tour="bill-d365-actions"]',
            title: 'D365 BC Action Buttons',
            body:
              'These actions integrate directly with Dynamics 365 Business Central. “Create Sales Order” posts the full payload via OData API, “Simulate Posting” validates outcomes, and “Open in Business Central” deep-links to the live SO.',
          },
        ],
      },
      {
        ...
        subSteps: [
          {
            id: 'payload',
            selector: '[data-tour="bill-payload"]',
            title: 'D365 Payload Preview',
            body:
              'Preview the exact JSON payload the Billing Agent will send to D365 BC. This provides full transparency, improves trust, and helps developers and auditors verify mappings from contract data to ERP fields.',
          },
        ],
      },
      {
        ...
        subSteps: [
          {
            id: 'action-bar',
            selector: '[data-tour="bill-approve-bar"]',
            title: 'Action Bar',
            body:
              'Approve and continue to trigger the next Agentic steps (Tax Determination → Approval Workflow). Re-running the Billing Agent recalculates the SO from source context, and saving a draft preserves changes for traceability.',
          },
        ],
      },
      {
        ...
        subSteps: [
          {
            id: 'top-actions',
            selector: '[data-tour="bill-action-bar"]',
            title: 'Quick Actions (Top Bar)',
            body:
              'These quick controls match the operational workflow: simulate, preview, create in D365, and rerun the Billing Agent. The system maintains an audit trail of each action and ensures consistency across cases.',
          },
        ],
      },
      {
        ...
        subSteps: [
          {
            ...
            body:
              'Excellent! You now understand how the Billing Agent converts contract context into accurate Sales Orders and pushes them into Dynamics 365 Business Central. Standard cases stay zero-touch; only exceptions require review. Restart this tour anytime from the help menu.',
          },
        ],
      },
    ],
            ...
            <div className="flex items-start justify-between gap-3">
              <div>
                ...
                <div className="mt-2 text-sm text-slate-600 dark:text-slate-400">
                  You now understand how the Billing Agent converts contract context into accurate Sales Orders and pushes them directly into Dynamics 365 Business Central. Standard cases remain zero-touch, with HITL review only for non-standard terms.
