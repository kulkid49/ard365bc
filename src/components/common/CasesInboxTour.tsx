...
const STORAGE_KEY = 'qa.casesInboxTour.completed'
...
export function CasesInboxTour({ sampleCaseId }: { sampleCaseId: string }) {
  const [searchParams, setSearchParams] = useSearchParams()
  const forceStart = searchParams.get('tour') === 'cases'
    ...
    () => [
      {
        ...
        subSteps: [
          {
            id: 'header',
            selector: '[data-tour="cases-header"]',
            title: 'Cases Inbox',
            body:
              'Welcome to the Cases Inbox — your operational workspace for active cases and exceptions. This view complements the Transaction Pipeline by focusing on what needs attention now: HITL, approvals, and edge cases.',
          },
        ],
      },
      {
        ...
        subSteps: [
          {
            id: 'search',
            selector: '[data-tour="cases-search"]',
            title: 'Search & Triage',
            body:
              'Search across Case ID, customer, and D365 references to find any transaction instantly. This is how teams move fast while keeping full visibility over the Agentic AI flow.',
          },
        ],
      },
      {
        ...
        subSteps: [
          {
            ...
            title: 'Inbox Table',
            body:
              'Every row is a live case in the Agentic pipeline. Use this inbox to monitor exceptions, prioritize workload, and quickly open a full case view when Human-in-the-Loop decisions are required.',
          },
        ],
      },
      {
        ...
        subSteps: [
          {
            id: 'col-caseid',
            selector: '[data-tour="cases-col-caseid"]',
            title: 'Case ID (Clickable)',
            body:
              'Click to open the full Case Detail view with timeline, documents, and audit trail. This creates a transparent chain-of-custody from intake to dispatch across D365 BC updates.',
          },
          {
            id: 'col-customer',
            selector: '[data-tour="cases-col-customer"]',
            title: 'Customer Context',
            body:
              'Customer context influences validations, approvals, and risk. Agentic AI uses this to route work correctly and keep processing compliant and scalable.',
          },
          {
            id: 'col-stage',
            selector: '[data-tour="cases-col-stage"]',
            title: 'Stage',
            body:
              'Stage tells you where the case sits in the 10-step process. It’s the quickest way to understand what operation is happening now — extraction, tax validation, approval, or dispatch.',
          },
          {
            id: 'col-status',
            selector: '[data-tour="cases-col-status"]',
            title: 'Status Badge',
            body:
              'Status shows whether the case is flowing zero-touch (Auto), needs review (HITL), or is blocked/failed. Color-coded signals make prioritization immediate.',
          },
        ],
      },
      {
        ...
        subSteps: [
          {
            id: 'preview',
            selector: '[data-tour="cases-preview"]',
            title: 'Case Preview Panel',
            body:
              'Select any case to see a quick operational summary without leaving the inbox. This is designed for speed: validate context, check D365 readiness, and take action immediately.',
          },
        ],
      },
      {
        ...
        subSteps: [
          {
            id: 'd365',
            selector: '[data-tour="cases-d365-links"]',
            title: 'D365 BC Deep Links',
            body:
              'Open Sales Order or Invoice records directly in Dynamics 365 Business Central. This is how Agentic AI stays grounded in real ERP state while keeping every action traceable.',
          },
        ],
      },
      {
        ...
        subSteps: [
          {
            id: 'actions',
            selector: '[data-tour="cases-actions"]',
            title: 'Operational Actions',
            body:
              'Re-run agents, send to HITL, or export the full case package. These controls help you intervene safely when needed — without breaking the autonomous flow or audit trail.',
          },
        ],
      },
      {
        ...
        subSteps: [
          {
            id: 'pagination',
            selector: '[data-tour="cases-pagination"]',
            title: 'Pagination & Export',
            body:
              'Navigate through larger inbox volumes and export the filtered view. Export is especially useful for collaboration while preserving D365 references and operational context.',
          },
        ],
      },
      {
        ...
        subSteps: [
          {
            id: 'legend',
            selector: '[data-tour="cases-legend"]',
            title: 'Status Legend',
            body:
              'Green indicates completed outcomes, blue signals automated flow, amber indicates Human-in-the-Loop review, and red/orange highlight failures or blocks. Use these to prioritize the inbox instantly.',
          },
        ],
      },
      {
        ...
        subSteps: [
          {
            id: 'sample',
            selector: sampleCaseId ? '[data-tour="cases-sample-row"]' : '[data-tour="cases-table"]',
            title: 'Open Any Case',
            body:
              'Pick a case to review the full lifecycle in Case Detail: documents, timeline, and audit events. This is the end-to-end story of autonomous agents working with HITL checkpoints when required.',
          },
        ],
      },
      {
        ...
        subSteps: [
          {
            ...
            title: 'You’re Ready',
            body:
              'You now know how to triage and manage exceptions in the Cases Inbox while keeping full control and visibility over Agentic AI execution. Restart this tour anytime from the help menu.',
          },
        ],
      },
    ],
            ...
            <div className="flex items-start justify-between gap-3">
              <div>
                ...
                <div className="mt-2 text-sm text-slate-600 dark:text-slate-400">
                  You’re ready to operate the Cases Inbox with confidence: rapid triage, Human-in-the-Loop control, and seamless D365 BC traceability. Restart this tour anytime from the help menu.
                </div>
              </div>
